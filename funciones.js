...
/*function Duenio(nombreDn,apellidoDn,dniDn,domicilioDn,numCll,barrio,codigoPP){
    this.nombreDn=nombreDn
    this.apellidoDn=apellidoDn
    this.dniDn=dniDn
    this.domicilioDn=domicilioDn
...
function crearDuenio(){
    ...
    let barrio=prompt("ingrese barrio")
    let codigoPP=Number(prompt("codigoPP"))
    var nvoduenio = new Duenio (nombreDn,apellidoDn,dniDn,domicilioDn,numCll,barrio,codigoPP)
}


function Inquilino(nombreIq,apellidoIq,dniIq,domicilioIq,numIq,barrioIq,diaPg,mesPg,anioPg,diaIc,mesIc,anioIc,codigoPP){
    this.nombreIq=nombreIq
    this.apellidoIq=apellidoIq
    this.dniIq=dniIq
    this.domicilioIq=domicilioIq
...
function crearInquilino(){
    ...
    let anioIc=Number(prompt("ingrese el año"))
    let codigoPP=Number(prompt("codigoPP"))
    const inquilino = new Inquilino (nombreIq,apellidoIq,dniIq,domicilioIq,numCll,barrio,diaPg,mesPg,anioPg,diaIc,mesIc,anioIc,codigoPP)
    return inquilino
}
//const inquilino1= crearInquilino();
//console.log(inquilino1)

function Propiedad(tipoPP,direccionPP,numCllPP,barrioPP,zonaPP,aptoParaVV,aptoParaCm,codigoPP){
    this.tipoPP=tipoPP
...
function crearPropiedad(){
    ...
    let codigoPP=Number(prompt("codigoPP"))
    const propiedad = new Propiedad (nombreIq,apellidoIq,dniIq,domicilioIq,numCll,barrio,diaPg,mesPg,anioPg,diaIc,mesIc,anioIc,codigoPP)
    return propiedad
}
